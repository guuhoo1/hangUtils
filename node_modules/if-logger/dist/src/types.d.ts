...
export declare type FnOrStr = (() => string) | string;
export declare type FnOrStrList = FnOrStr[];
export declare type Tags = FnOrStrList[] | FnOrStr[];
...
export interface ILoggerOption {
    ...
    pred?: (() => any) | any;
    transports?: ((level: string, message: string, formatMessage: string, time?: number, timeEndLimit?: number) => any)[];
    returnValue?: boolean;
    timeEndLimit?: number;
}
